...
describe('Course e2e test', () => {
    ...
    it('should load Courses', async () => {
        ...
        expect(await courseComponentsPage.getTitle()).toMatch(/armoryApp.course.home.title/);
    });
    ...
    it('should load create Course page', async () => {
        ...
        expect(await courseUpdatePage.getPageTitle()).toMatch(/armoryApp.course.home.createOrEditLabel/);
