...
describe('Discipline e2e test', () => {
    ...
    it('should load Disciplines', async () => {
        ...
        expect(await disciplineComponentsPage.getTitle()).toMatch(/armoryApp.discipline.home.title/);
    });
    ...
    it('should load create Discipline page', async () => {
        ...
        expect(await disciplineUpdatePage.getPageTitle()).toMatch(/armoryApp.discipline.home.createOrEditLabel/);
