...
describe('Lesson e2e test', () => {
    ...
    it('should load Lessons', async () => {
        ...
        expect(await lessonComponentsPage.getTitle()).toMatch(/armoryApp.lesson.home.title/);
    });
    ...
    it('should load create Lesson page', async () => {
        ...
        expect(await lessonUpdatePage.getPageTitle()).toMatch(/armoryApp.lesson.home.createOrEditLabel/);
