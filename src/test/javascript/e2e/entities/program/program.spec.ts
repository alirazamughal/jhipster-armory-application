...
describe('Program e2e test', () => {
    ...
    it('should load Programs', async () => {
        ...
        expect(await programComponentsPage.getTitle()).toMatch(/armoryApp.program.home.title/);
    });
    ...
    it('should load create Program page', async () => {
        ...
        expect(await programUpdatePage.getPageTitle()).toMatch(/armoryApp.program.home.createOrEditLabel/);
