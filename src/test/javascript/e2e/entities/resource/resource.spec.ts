...
describe('Resource e2e test', () => {
    ...
    it('should load Resources', async () => {
        ...
        expect(await resourceComponentsPage.getTitle()).toMatch(/armoryApp.resource.home.title/);
    });
    ...
    it('should load create Resource page', async () => {
        ...
        expect(await resourceUpdatePage.getPageTitle()).toMatch(/armoryApp.resource.home.createOrEditLabel/);
