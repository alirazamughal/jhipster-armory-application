    ...
    describe('Discipline Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/disciplines';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Discipline', () => {
                service.create(new Discipline(null)).subscribe(received => {
            ...
            it('should update a Discipline', () => {
                service.update(new Discipline(123)).subscribe(received => {
